...
public class Main {
    public static void main(String[] args){
        ...
        mostrarMensagem(cartaoMaes);
        System.out.println();
        mostrarMensagem(cartaoNamorados);
        System.out.println();
        mostrarMensagem(cartaoNatal);
    }

    public static void mostrarMensagem(CartaoDePresente cartaoDePresente){
